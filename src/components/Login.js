      ...
      createUserWithEmailAndPassword(
        ...
        .then((userCredential) => {
          ...
          updateProfile(auth.currentUser, {
            ...
            photoURL:
              "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSFZCtRqjiSeqLrCLB4iQC6U4ritastUxbmFA&s",
          })
            .then(() => {
  ...
  return (
    <div>
      ...
      <form
        ...
        className="w-3/12 mx-auto right-0 left-0 my-36 absolute bg-black p-20  text-white rounded-lg bg-opacity-80"
      >
